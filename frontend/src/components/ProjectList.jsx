        ...
        <div className="grid gap-4">
          {projects.map(p => (
            <div
              ...
              className="bg-slate-800 rounded-xl p-5 cursor-pointer hover:bg-slate-750 hover:ring-1 hover:ring-slate-600 transition group"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">{p.domain}</p>
                  </div>
                </div>
                    ...
                    <div className="text-right">
                      ...
                      {p.avg_score !== null && (
                        <div className="text-sm font-medium" style={{
                          ...
                          Score: {(p.avg_score * 100).toFixed(0)}%
                        </div>
                      )}
                    </div>
                  )}
